...
class Point3dTest : public CxxTest::TestSuite {
    public:
        ...
        void test_create_point_from_str();
};
...
//}}}
void Point3dTest::test_create_point_from_str() {
    Point3D point("(1,2,3)");
    cout << point.to_string() << endl;
    TSM_ASSERT(point.to_string(), point.x == 1);
    TSM_ASSERT(point.to_string(), point.y == 2);
    TSM_ASSERT(point.to_string(), point.z == 3);
    ...
    point = Point3D("       (1   ,     4        ,        9.3)  \n");
    cout << point.to_string() << endl;
    TSM_ASSERT(point.to_string(), point.x == 1);
    TSM_ASSERT(point.to_string(), point.y == 4);
    TSM_ASSERT(point.to_string(), point.z == 9.3);
}
